...
//     features: ['Full market access', 'Premium support', 'daily with draws withdrawals', 'Maximum earnings'],
//     icon: TrendingUp,
...
//     features: ['Market access', 'Standard support', 'daily  withdrawals', 'Good returns'],
//     icon: DollarSign,
...
//     features: ['Basic access', 'Email support', 'daily withdraws withdrawals', 'Steady growth'],
//     icon: Users,
...
//     features: ['Limited access', 'Basic support', 'daily with draws withdrawals', 'Entry returns'],
//     icon: Calendar,
