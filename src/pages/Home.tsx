...
export default function Home() {
  ...
  const packages = [
    {
      name: '7th Stock Package',
      price: 192000,
      dailyReturn: 28800,
      popular: true
    },
    {
      name: '6th Stock Package',
      price: 96000,
      dailyReturn: 14400,
      popular: false
    },
    {
      name: '5th Stock Package',
      price: 48000,
      dailyReturn: 7200,
      popular: false
    },
    {
      name: '4th Stock Package',
      price: 24000,
      dailyReturn: 3600,
      popular: false
    },
    {
      name: '3rd Stock Package',
      price: 12000,
      dailyReturn: 1800,
      popular: false
    },
    {
      name: '2nd Stock Package',
      price: 6000,
      dailyReturn: 900,
      popular: false
    },
    {
      name: '1st Stock Package',
      price: 3000,
      dailyReturn: 450,
      popular: false
    }
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-gold-100 to-gol d-50 rounded-2xl p-8 max-w-2xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {!user ? (
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/register"
                className="bg-gold-500 hover:bg-gold-600 text-black px-8 py-4 rounded-lg font-semib old text-lg transition-all transform hover:scale-105 flex items-center justify-center space-x-2"
              >
