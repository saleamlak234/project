    ...
    <div className="min-h-screen py-8 bg-gray-50">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-4">
          ...
          {/* Example: Add lockout/attempts alert for admin actions */}
          {(stats?.recentUsers || []).some(u => (u as { isLocked?: boolean }).isLocked) && (
            <div className="flex items-center p-4 space-x-3 border border-red-200 rounded-lg bg-red-50">
              <AlertCircle className="flex-shrink-0 w-5 h-5 text-red-600" />
              <div>
                <p className="font-medium text-red-800">
                  Some users are currently locked out due to too many failed login attempts.
                </p>
                <Link
                  to="/admin/users"
